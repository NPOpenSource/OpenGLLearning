...
@end
@implementation LearningBlendView
- (BOOL)loadShaders{
    self.bgShader = [[ShaderManager alloc]init];
    [self.bgShader CompileLinkSuccessShaderName:@"bgShader" glBindAttribLocationBlock:^(GLuint program) {
